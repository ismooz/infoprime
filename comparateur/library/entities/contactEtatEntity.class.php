...
/**
 * Class contactEtatEntity
 * @author Vazquez Luis
 * @copyright (c) 2015, Syntesis Management SA
 */
class contactEtatEntity extends entity {
    ...
    /**
     * @access protected
     * @var \DateTime - Date de modification du status de contact
     */
    public $dateModification;
    
    /**
     * getName() - Retourne le nom du status du status de contact
     * @access public
